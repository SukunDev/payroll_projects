...
@section('content')
    ...
    @component('layouts.components.sidebar', [
        'title' => 'Payroll <span class="font-normal text-slate-300">Admin</span>',
        'sidebar_url' => '/admin',
        'items' => [
            ['type' => 'links', 'name' => 'dashboard', 'icon_name' => 'home', 'href' => 'admin'],
            ['type' => 'links', 'name' => 'pegawai', 'icon_name' => 'person', 'href' => 'admin/pegawai'],
        ],
    ])
    @endcomponent
    <div class="ml-72">
